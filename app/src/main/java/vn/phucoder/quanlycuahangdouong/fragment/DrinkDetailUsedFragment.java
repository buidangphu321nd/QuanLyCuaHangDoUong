        ...
        MyApplication.get(getActivity()).getHistoryDatabaseReference()
                .addValueEventListener(new ValueEventListener() {
                    ...
                    public void onCancelled(@NonNull DatabaseError databaseError) {
                        Toast.makeText(getActivity(), "Không lấy được dữ liệu, vui lòng kiểm tra lại kết nối mạng",
                    ...
                    if (getActivity() != null) {
                        MyApplication.get(getActivity()).getHistoryDatabaseReference()
                                ...
                                .setValue(history, (error, ref) -> {
                                    Toast.makeText(getActivity(),"Thêm lịch sử đồ uống thành công",Toast.LENGTH_SHORT).show();
                    ...
                    if (getActivity() != null) {
                        MyApplication.get(getActivity()).getHistoryDatabaseReference()
                                ...
                                .updateChildren(map, (error, ref) -> {
                                    hideSoftKeyboard(getActivity());
                                    Toast.makeText(getActivity(),"Chỉnh sửa lịch sử tiêu thụ đồ uống thành công",Toast.LENGTH_SHORT).show();
        ...
        new AlertDialog.Builder(getActivity())
                ...
                .setPositiveButton("Xóa", (dialogInterface, i)
                        ...
                        .removeValue((error, ref) -> {
                            Toast.makeText(getActivity(),"Xóa lịch sử tiêu thụ đồ uống thành công",Toast.LENGTH_SHORT).show();
